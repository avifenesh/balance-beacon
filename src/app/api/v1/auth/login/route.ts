...
export async function POST(request: NextRequest) {
  try {
    ...
    // 1. IP-based rate limiting to prevent password spraying across multiple accounts
    ...
    // 2. Email-based rate limit login attempts (5/min for brute force protection)
