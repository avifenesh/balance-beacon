                  ...
                  {optimisticTransactions.length === 0 ? (
                    <>
                      ...
                      <button
                        ...
                        className="text-sm text-sky-400 hover:text-sky-300 font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/40 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 rounded-md px-2 py-1 -ml-2 transition"
                      >
                    ...
                    {!isOptimistic && (
                      <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1 sm:opacity-0 sm:pointer-events-none sm:group-hover:opacity-100 sm:group-hover:pointer-events-auto sm:group-focus-within:opacity-100 sm:group-focus-within:pointer-events-auto sm:transition-opacity">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-md bg-white/10 hover:bg-rose-500/30 text-slate-300 hover:text-rose-400 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-400/40 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                          title="Delete"
