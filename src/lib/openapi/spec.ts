      ...
      schemas: {
        ...
        CreateTransaction: {
          ...
          properties: {
            ...
            amount: { type: 'number', minimum: 0.01, maximum: 9999999999.99, example: 99.99 },
        ...
        CreateExpenseRequest: {
          ...
          properties: {
            ...
            amount: { type: 'number', minimum: 0.01, maximum: 9999999999.99, example: 50.0 },
            currency: { $ref: '#/components/schemas/Currency' },
            date: { type: 'string', format: 'date-time' },
            description: { type: 'string', maxLength: 240, nullable: true },
          },
        ...
        CreateBudget: {
          ...
          properties: {
            ...
            planned: { type: 'number', minimum: 0, maximum: 9999999999.99, example: 500.0 },
            currency: { $ref: '#/components/schemas/Currency' },
        ...
        CreateMonthlyIncomeGoal: {
          ...
          properties: {
            accountId: { type: 'string', minLength: 1 },
            monthKey: { type: 'string', pattern: '^\\d{4}-(0[1-9]|1[0-2])$', example: '2026-01' },
            amount: { type: 'number', minimum: 0.01, maximum: 9999999999.99, example: 5000.0 },
            currency: { $ref: '#/components/schemas/Currency' },
            notes: { type: 'string', maxLength: 240, nullable: true },
        ...
        CreateHolding: {
          ...
          properties: {
            ...
            averageCost: { type: 'number', minimum: 0, maximum: 9999999999.99, example: 150.0 },
            currency: { $ref: '#/components/schemas/Currency' },
            notes: { type: 'string', maxLength: 240, nullable: true },
          },
        ...
        UpdateHolding: {
          ...
          properties: {
            ...
            averageCost: { type: 'number', minimum: 0, maximum: 9999999999.99 },
            notes: { type: 'string', maxLength: 240, nullable: true },
          },
        ...
        CreateRecurring: {
          ...
          properties: {
            ...
            categoryId: { type: 'string', minLength: 1 },
            type: { $ref: '#/components/schemas/TransactionType' },
            amount: { type: 'number', minimum: 0.01, maximum: 9999999999.99, example: 100.0 },
            currency: { $ref: '#/components/schemas/Currency' },
